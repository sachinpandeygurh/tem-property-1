...
const LoginPage: React.FC = () => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const response = await axios.post('https://nextdealappserver.onrender.comapi/v1/temp/login/send-otp', {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const response = await axios.post('https://nextdealappserver.onrender.comapi/v1/temp/login/verify-otp', {
        mobileNumber: formData.mobileNumber,
        otp: otpData.otp
      });
